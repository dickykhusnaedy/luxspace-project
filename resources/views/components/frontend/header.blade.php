			...
			<div class="w-auto">
				...
				>
					<li class="mx-3 py-6 md:py-0">
						<a href="#" class="text-black md:{{ \Route::current()->getName() == 'index' ? 'text-white' : 'text-black' }} hover:underline"
							>Showcase</a
						>
					</li>
					<li class="mx-3 py-6 md:py-0">
			...
			<div class="w-auto">
				<ul class="items-center flex">
					<li class="ml-6 block md:hidden">
						<button
							id="menu-toggler"
							class="relative flex z-50 items-center justify-center w-8 h-8 text-black md:{{ \Route::current()->getName() == 'index' ? 'text-white' : 'text-black' }} focus:outline-none"
						>
							<svg
								class="fill-current"
								width="18"
					...
					<li class="ml-6">
						<a
							id="header-cart"
							class="flex items-center justify-center w-8 h-8 text-black md:{{ \Route::current()->getName() == 'index' ? 'text-white' : 'text-black' }}"
							href="cart.html"
						>
							<svg
								class="fill-current"
