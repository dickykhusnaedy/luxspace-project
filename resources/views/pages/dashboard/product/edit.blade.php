<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      @endif
      <form action="{{ route('dashboard.product.update', $product->id) }}" method="post" class="w-full"
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="w-full flex justify-end px-3 mt-5">
            <button type="submit"
              class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 text-sm rounded-full shadow-lg">
              Update Product
            </button>
          </div>
        </div>
